      ...
      <div class="row">
        <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
          ...
          <div class="contact-box__info">
            <a href="tel:+905389818597" class="contact-box__info--title">Teklif Alın!</a>
            <p class="contact-box__info--subtitle">  Pzt-Cum 09:00-18:00</p>
          </div>
        </div>  
        <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
          <div class="contact-box__icon">
          ...
          <div class="contact-box__info">
            <a href="mailto:plefsoft@gmail.com" class="contact-box__info--title">plefsoft@gmail.com</a>
            <p class="contact-box__info--subtitle">Canlı Destek</p>
          </div>
        </div>
        <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
          <div class="contact-box__icon">
          ...
          <div class="contact-box__info">
            <a href="#" class="contact-box__info--title">İstanbul, Türkiye</a>
            <p class="contact-box__info--subtitle">34000, TR</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row text-center text-white">
          <div class="col-12">
            <div class="footer-bottom__copyright">
              &COPY; Copyright 2024 <a href="{{route('index')}}">PlefSoft</a>
            </div>
          </div>
        </div>
      </div>
